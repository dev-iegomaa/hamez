...
<head>
    ...
    <link href="{{ asset('adminAssets/en/assets/css/pages/error/style-400.css') }}" rel="stylesheet" type="text/css" />
    ...
    <div class="row">
        <div class="col-md-4 mr-auto mt-5 text-md-left text-center">
            <a href="#" class="ml-md-5">
                <img alt="image-404" src="{{ asset('adminAssets/en/assets/img/90x90.jpg') }}" class="theme-logo">
            </a>
        </div>
    </div>
</div>
