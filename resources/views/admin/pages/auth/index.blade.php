...
<head>
    ...
    @if(LaravelLocalization::getCurrentLocale() == 'en')
        ...
        <link href="{{ asset('adminAssets/en/assets/css/authentication/form-2.css') }}" rel="stylesheet" type="text/css" />
    ...
    @else
        ...
        <link href="{{ asset('adminAssets/ar/assets/css/authentication/form-2.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="form-form-wrap">
            <div class="form-container">
                <div class="form-content">
                    ...
                    <form class="text-left" action="{{ route('admin.auth.login') }}" method="post">
                        @csrf
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input name="email" type="text" class="@error('email') is-invalid @enderror form-control" placeholder="e.g John_Doe@gmail.com">
                            </div>
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input id="password" name="password" type="password" class="@error('password') is-invalid @enderror form-control">
...
@if(LaravelLocalization::getCurrentLocale() == 'en')
    ...
    <script src="{{ asset('adminAssets/en/assets/js/authentication/form-2.js') }}"></script>
@else
    <!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
    ...
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="{{ asset('adminAssets/ar/assets/js/authentication/form-2.js') }}"></script>
@endif
